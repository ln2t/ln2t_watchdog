...
echo -e "     ${YELLOW}ln2t-watchdog --help${NC}"
echo ""
echo -e "  2. Check timer status:"
echo -e "     ${YELLOW}systemctl --user status ln2t-watchdog.timer${NC}"
echo ""
echo -e "  3. Generate a template configuration:"
echo -e "     ${YELLOW}ln2t-watchdog init -o my_config.yaml${NC}"
echo ""
echo -e "  4. Place configs in your dataset directories:"
echo -e "     ${YELLOW}~/code/YYYY-Adjective_Animal-randomString-code/ln2t_watchdog/*.yaml${NC}"
echo -e "     ${YELLOW}or (hidden): ~/code/YYYY-Adjective_Animal-randomString-code/.ln2t_watchdog/*.yaml${NC}"
echo ""
echo -e "  5. Manually trigger a scan (optional):"
echo -e "     ${YELLOW}ln2t-watchdog run --dry-run${NC}    # preview"
echo -e "     ${YELLOW}ln2t-watchdog run${NC}              # execute"
echo ""
echo -e "  6. Monitor execution:"
echo -e "     ${YELLOW}ln2t-watchdog status${NC}"
echo -e "     ${YELLOW}ln2t-watchdog logs${NC}"
echo ""
